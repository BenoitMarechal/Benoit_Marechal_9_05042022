...
export default (bill) => {
	//Ajout d'une div 'status et d'une ternaire pour traduire le status en français
	return `
    <div class="container dashboard-form" data-testid="dashboard-form">

    <div class="row">
    <div class="col-sm">
      <label for="file" class="bold-label">Statut</label>
        <div class='input-field input-flex file-flex-status'>
        <span id="file-status">${
					bill.status === 'pending'
						? 'En cours'
        ...
        <div class="col-sm">
          <label for="file" class="bold-label">Justificatif</label>
            ...
            <span id="file-name-admin">${
							bill.fileName === 'null' ? 'PAS DE JUSTIFICATIF' : bill.fileName
						}</span>   
